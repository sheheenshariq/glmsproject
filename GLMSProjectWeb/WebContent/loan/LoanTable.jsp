        ...
        <div class="container-fluid">
         ...
         <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <!-- <a href="LoanDetails.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" s>Generate Report</a> -->
          </div>
 ...
 %>
  ...
  %>
   ...
   %>
    ...
    <td><%=loan.getNetGoldwt()%>&nbsp;</td>
    <td><%=loan.getInterestRate()%>&nbsp;</td>
    <td><%=loan.gettenure()%>&nbsp;</td>
    <td><%=loan.getDescription()%>&nbsp;</td>
    <td><a href="deleteLoandetails.jsp?ACCOUNT_NUMBER=<%=loan.getAccountNo() %>" onclick="return confirm('Are You Sure To Delete!!!')">DELETE</a></td>
    </tr>
   <%
  	 }
   }
    ...
    %>
         <tr>
         <td colspan="7">No Loan Details Found!!!!!!</td>
         </tr>
   <%
	}
   %>
