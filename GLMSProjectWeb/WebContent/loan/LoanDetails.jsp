...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div align="right" >
            <a href="../loan/LoanAppl.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> New Loan</a>
  ...
  <br>
   <br>
  <br>
     <form action="SingleLoanDetail.jsp" method="post" > 
      <div align="Center" >  
     <label class="input">

		<!-- <input type="text" placeholder="Account Number"> -->
		<select name="sltaccountNo" id="sltaccountNo">
		...
		<option value='<%= loan.getAccountNo() %>'><%= loan.getAccountNo() %></option>
		<%
		                }
		             }
		%>
