...
<body id="page-top">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto"> 
           ...
           <div align="right">  <span style="float:right;margin-left:200px" class="mr-2 d-none d-lg-inline text-gray-600 small">ADMIN</span> </div> 
  ...
  <!-- Logout Modal-->
      ...
      <form action="addLoandetails_process.jsp" class="sky-form" method="post" onsubmit="return validate1();">
        <fieldset>
					...
					<!-- <section>
						<label class="input">
							...
							<b class="tooltip tooltip-bottom-right">Enter the Loan ID</b>
						</label>
					</section> -->
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Account Number" name="txtaccount_no" id="txtaccount_no" >
							<b class="tooltip tooltip-bottom-right">Enter the Account number</b>
						</label>
					</section>
					<!--  <section>
						<label class="input">
						
							<input type="text" placeholder="Amount Issued" name="txtloan_amount" id="txtloan_amount">
							<b class="tooltip tooltip-bottom-right">Enter the Amount Issued</b>
						</label>
					</section>-->
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Net Gold Weight" name="txtnet_gold_wt" id="txtnet_gold_wt">
							<b class="tooltip tooltip-bottom-right">Enter the Net Gold Weight</b>
						</label>
					</section>
					...
					<section>
						<label class="input">
						  Interest Rate	
							<!--  <input type="text" placeholder="Interest Rate" name="txtinterest_rate" id="txtinterest_rate">-->
							<b class="tooltip tooltip-bottom-right">Enter the Interest Rate</b>
						<select class="form-control" name="sltLoanrate" id="sltLoanrate">
						<% ArrayList<InterestRateDTO> rois = InterestRateBL.getInterest_rate_change();
						if(rois!=null && rois.size()>0)
						{
						     for(InterestRateDTO roi : rois)
						      {
						
						%>
                       <option value='<%= InterestRateBL.getrates() %>'><%= InterestRateBL.getrates() %></option>
					   <%
								}
						}
						%>
					...
					<section>
						<label class="input">
							...
							<input type="number" placeholder="Tenure in Years" name="txttenure" id="txttenure" >
							<b class="tooltip tooltip-bottom-right">Enter the Tenure in Years</b>
						</label>
					</section>
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Description" name="txtdescription" id="txtdescription">
