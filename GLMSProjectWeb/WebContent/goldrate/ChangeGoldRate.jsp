...
<body id="page-top">
        ...
        <div class="container-fluid">
         ...
         <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Gold Rate</h1>
      <a href="UpdateGoldRate.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Change Gold Rate</a>
          </div>
  ...
  <%
	  ArrayList<GoldRateDTO> goldrates = GoldRateBL.getGold_Rate();
	  if(goldrates!=null &&  goldrates.size()>0)
	   {
  %>
<table width="80%"  align="center" class="table table-striped table-hover">
    ...
    <%
		for(GoldRateDTO goldrate : goldrates)
		{
     %>
       <tr>
          <td><%=goldrate.getGold_rate()%>&nbsp;</td>
          <td><%=goldrate.getDate()%>&nbsp;</td>
       </tr>
