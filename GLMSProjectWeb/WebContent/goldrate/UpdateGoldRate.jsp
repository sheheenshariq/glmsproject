...
<body id="page-top">
  ...
  <br>
  <br>
     <form action="addGoldRate_process.jsp" method="post" > 
      <div align="Center" >  
     <label class="input">

<input type="text" placeholder=" Enter the new Gold Rate" name="txtgold_rate" id="txtgold_rate">
</label><br><br>
<label><input type="date"  name="txtdate" id="txtdate"></label>
<footer>
