...
<body id="page-top">
                           ...
                           <%
						  account_no = request.getParameter("sltAccountNumber");
						  login=LoginBL.getLogin(account_no);

	                      String ac=(String)session.getAttribute("account_no");
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="../styles/logout.jsp" data-toggle="modal" data-target="#logoutModal">
