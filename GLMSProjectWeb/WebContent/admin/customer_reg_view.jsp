...
<head>
  ...
  <script src='https://kit.fontawesome.com/a076d05399.js'></script>
					...
					<%
					 ...
					 %>
<title>Customer Registered Information</title>
...
<table width="50%"  align="center" class="table table-striped table-hover">
                <thead>
                    <tr>
                    <th>Customer Name</th>
                    <th>Gender</th>
         ...
         <tr>
         <td height="30"><%=customer.getCustomer_name()%>&nbsp;</td>
         <td><%=customer.getGender()%>&nbsp;</td>
         <td><%=customer.getAddress()%>&nbsp;</td>
         <td><%=customer.getAadhar()%>&nbsp;</td>
         <td><%=customer.getContact_no()%>&nbsp;</td>
         <td><%=customer.getAccount_no()%>&nbsp;</td>
         <td align="left" valign="middle"><a href="customer_edit.jsp?ACCOUNT_NUMBER=<%= customer.getAccount_no()%>">Update</a>&nbsp;</td>
	     <td align="left" valign="middle"><a href="deleteCustomer.jsp?ACCOUNT_NUMBER=<%=customer.getAccount_no()%>" onclick="return confirm('Are you sure?')">Delete</a>&nbsp;</td>
        </tr>
         <%
         }
       }
