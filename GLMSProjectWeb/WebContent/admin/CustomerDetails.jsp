...
<!-- Topbar Search 
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div align="right" >
            <a href="CustomerReg.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> New Customer</a>
  ...
  <br>
  <br>
     <form action="CustomerTable.jsp" method="post" > 
      <div align="Center" >  
       <label class="input">
        <input type="text" placeholder="Account Number">
         <select name="sltAccountNumber" id="sltAccountNumber">
			...
			<option value='<%=customer.getAccount_no() %>'><%= customer.getAccount_no() %></option>
