...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../CustomerView/customerChoose.jsp">
         <i class='far fa-file-alt' style='font-size:20px'></i>
          <span>Customer Details</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="../CustomerView/loanChoose.jsp">
        <i class='far fa-file-alt' style='font-size:20px'></i>
          <span>Loan Details</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="../Customer/emiChoose.jsp">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> ....CUSTOMER VIEW....</h1>
            <div align="right" >
