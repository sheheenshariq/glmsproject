...
<table width="80%"  align="center" class="table table-striped table-hover">
                <thead>
                        ...
                        <tr><th>Account Number</th><td><%=payment.getAccountNo()%>&nbsp;</td></tr>
                        <tr><th>Emi Amount</th><td><%=payment.getEmiAmount()%>&nbsp;</td></tr>
                        <tr><th>Emi Date</th><td><%=payment.getEmiDate()%>&nbsp;</td></tr>
                        <tr><th>Payment Remaining</th><td><%=payment.getPaymentRemaining()%>&nbsp;</td></tr>   
                        <tr><th>Repayment Amount</th><td><%=payment.getRepaymentAmount()%>&nbsp;</td></tr>                         
  ...
  <table width="100%" border="0">
     <tbody>
       <tr><td>There is no such record</td></tr>
      </tbody>
  </table>
