...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item active">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../CustomerView/emiChoose.jsp">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"> ....EMI VIEW....</h1>
            <div align="right" >
  ...
  <br>
  <br>
     <form action="viewEmi.jsp" method="post" > 
      <div align="Center" >  
     <label class="input">

<input type="text" name="sltaccountNo"  placeholder=" Enter Account Number">
</label>

<footer>
<button type="submit" class="button">EMI!</button>
