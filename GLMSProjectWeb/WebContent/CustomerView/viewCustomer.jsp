...
<body id="page-top">
 ...
 customer=CustomerBL.getCustomer(accountNo);
if(customer!=null)
{
  ...
  //accountNo = request.getParameter("txtaccountNo");
  //String accountNo=(String)session.getAttribute("customer");
  //login=LoginBL.getLogin(accountNo);
   //customer=CustomerBL.getCustomer(accountNo);
  //if(customer!=null)
  //{
 %>
    <table width="80%"  align="center" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>Account Number</th><td><%=customer.getAccount_no()%>&nbsp;</td></tr>
                        <tr><th>Customer Name</th><td><%=customer.getCustomer_name()%>&nbsp;</td></tr>
                        <tr><th>Gender</th><td><%=customer.getGender()%>&nbsp;</td> </tr>
                        <tr><th>Address</th><td><%=customer.getAddress()%>&nbsp;</td></tr>  
                        <tr><th>Aadhar</th>   <td><%=customer.getAadhar()%>&nbsp;</td>  </tr>
...
<%
  ...
  <table width="100%" border="0">
     <tbody>
       <tr><td>No such account exist</td>
       </tr>
       </tbody>
       </table>
