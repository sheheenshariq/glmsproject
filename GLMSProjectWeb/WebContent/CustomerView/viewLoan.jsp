  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../styles/CustomerHome.jsp">
     ...
     <!--  <li class="nav-item active">
       ...
       <i class='fab fa-cc-amazon-pay' style='font-size:20px'></i>
         ...
         <li class="nav-item active">
        <a class="nav-link" href="../goldrate/ChangeGoldRate.jsp">
         ...
         <li class="nav-item active">
        <a class="nav-link" href="../roi/ChangeROI.jsp">
          <i class="fas fa-fw fa-cog"></i>
        ...
        <div class="container-fluid">
         ...
         <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Loan View</h1>
            <div align="right">
...
<table width="80%"  align="center" class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th>Account No</th><td><%=loan.getAccountNo()%>&nbsp;</td></tr>
                         <tr><th>Loan Amount</th><td><%=loan.getLoanAmount()%>&nbsp;</td></tr>
                         <tr><th>Issue date</th> <td><%=loan.getIssueDate()%>&nbsp;</td></tr>
                         <tr><th>Gold Weight</th>  <td><%=loan.getNetGoldwt()%>&nbsp;</td></tr> 
                         <tr><th>Tenure</th>  <td><%=loan.gettenure()%>&nbsp;</td></tr>
                             
                         <tr><th>Intererst rate</th> <td><%=loan.getInterestRate()%>&nbsp;</td></tr>
                         <tr><th>Description</th><td><%=loan.getDescription() %>&nbsp;</td></tr>
  ...
  <table width="100%" border="0">
     <tbody>
       <tr><td>No such loan is taken</td>
       </tr>
       </tbody>
       </table>
