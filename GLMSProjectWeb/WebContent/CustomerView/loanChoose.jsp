...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../styles/Home-.jsp">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="../Customer/viewLoan.jsp">
        <i class='far fa-file-alt' style='font-size:20px'></i>
          <span>Loan Details</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="../CustomerView/viewEmi.jsp">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">YOUR LOAN DETAILS</h1>
            <div align="right" >
  ...
  <br>
   <br>
  <br>
     <form action="viewLoan.jsp" method="post" > 
      <div align="Center" >  
     <label class="input">
