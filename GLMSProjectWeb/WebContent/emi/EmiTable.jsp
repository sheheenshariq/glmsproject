...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form>
          <div>
          <span><h4>Gold Emi Management System</h4></span>
          </div>
          </form>
        ...
        <div class="container-fluid">
         ...
         <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Emi Details</h1>
            <!-- <a href="EmiDetails.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" s>Generate Report</a> -->
          </div>
  ...
  <%
  ArrayList<EmiDTO> emis = EmiBL.getEmis();
...
<table width="80%"  align="center" class="table table-striped table-hover">
	...
	for(EmiDTO emi : emis)
	{
	 %>
    <tr>
    <td><%=emi.getAccountNo()%>&nbsp;</td>
    <td><%=emi.getEmiAmount()%>&nbsp;</td>
    <td><%=emi.getEmiDate()%>&nbsp;</td>
    <td><%=emi.getPaymentNo()%>&nbsp;</td>
    </tr>
<%
  	}
   }
   else
	{
		 %>
         <tr>
         <td colspan="4">No Emi Details Found!!!!!!</td>
         </tr>
       <%
	}
%>
