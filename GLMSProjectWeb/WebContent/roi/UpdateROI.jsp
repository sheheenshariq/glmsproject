...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">New Gold Rate</h1>
            <div align="right" >
  ...
  <br>
   <br>
  <br>
     <form action="addInterestRate_process.jsp" method="post" > 
      <div align="Center" >  
     <label class="input">

<input type="text" placeholder=" Enter the new Rate of Interest" name="ROI" id="ROI">
</label><br><br>
<label class="input">

<input type="date" placeholder=" Enter the updated date" name="ROI_DATE" id="ROI_DATE">
</label>
