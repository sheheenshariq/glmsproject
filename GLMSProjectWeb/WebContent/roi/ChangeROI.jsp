...
<title>Rate of Interest Table</title>
        ...
        <div class="container-fluid">
         ...
         <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Rate of Interest</h1>
      <a href="UpdateROI.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Change ROI</a>
          </div>
...
<%
  ArrayList<InterestRateDTO> InterestRate = InterestRateBL.getInterest_rate_change();
...
<table width="80%"  align="center" class="table table-striped table-hover">
   ...
   <%
   for(InterestRateDTO roi : InterestRate)
   {
   %>
         <tr>
         <td height="30"><%=roi.getInterest_rate_change()%>&nbsp;</td>
         <td height="30"><%=roi.getRoi_date()%>&nbsp;</td>       
         </tr>
   <%
  }
}
...
%>
         <tr>
         <td colspan="7">No roi Details Found!!!!!!</td>
         </tr>
<%
}
%>
